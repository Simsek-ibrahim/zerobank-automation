...
public class PayBills_StepDefs {
    ...
    public void user_should_input_the_pay_requirements() {
        ...
        payBillsPage.dateInput.sendKeys("2022-12-22");
    ...
    @When("User should not to compşete pay operation by using invalid {string}, {string}> and {string}")
    public void user_should_not_to_compşete_pay_operation_by_using_invalid_and(String amount, String date, String description) {
        Select select=new Select(payBillsPage.payeeInput);
        select.selectByVisibleText("Bank of America");
    ...
    public void user_should_create_new_payee_using_following_information(Map<String,String>information) {
        ...
        payBillsPage.payeeInput(information.get("Payee Name"),information.get("Payee Address"),
            information.get("Account"),information.get("Payee details"));
